...
-- 1102 홍길동 남 테스트..... 32 99 무선사업부 수원......
-- 1103 임꺽정 남 테스트..... 32 99 무선사업부 수원......
-- 1104 장길산 여 테스트..... 32 99 무선사업부 수원......


-- Entity 부서
-- 99 무선사업부 수원.....
-- 1101 김연아 여 테스트..... 32 99 
-- 1102 홍길동 남 테스트..... 36 99 
-- 1103 임꺽정 남 테스트..... 31 99 
-- 1104 장길산 여 테스트..... 38 99 
...
-- dno는 emp와 dept에 모두 존재하므로 명시적으로 table명.column명과 같이 해야 한다.
...
SELECT grade, sal * 1.1 "인상 급여", eno, ename
 from emp, SALGRADE
